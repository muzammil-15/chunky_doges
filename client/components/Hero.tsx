...
const Hero = () => {
  return (
    <section className="relative h-[800px] sm:h-[1000px] bg-[url('/herobg.jpg')] bg-cover bg-center bg-no-repeat   overflow-hidden">
      {/* Background Image */}
      {/* <img
        src="/herobg.jpg"
        alt=""
        className="absolute left-0 w-full  h-full object-cover sm:object-cover "
      /> */}
